 ...
 */
class WPMozo_Addons_Gutenberg_Block_Interactiveimagecard extends WPMozo_Addons_Gutenberg_Block {
	...
	public function __construct() {
		...
		$this->styles[] = array(
			...
			'src'    => WPMOZO_ADDONS_GUTENBERG_SRC_DIR_URL . 'blocks/interactive-image-card/css/interactive-image-card.css',
			'deps'   => array(),
			'ver'    => time(),
		);
