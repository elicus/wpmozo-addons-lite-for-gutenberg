 ...
 */
class WPMozo_Addons_Gutenberg_Block_Beforeafterslider extends WPMozo_Addons_Gutenberg_Block {
	...
	public function __construct() {
		...
		$this->styles[] = array(
			...
			'src'    => WPMOZO_ADDONS_GUTENBERG_ASSETS_DIR_URL . 'css/twentytwenty.css',
			'deps'   => array(),
			'ver'    => time(),
		);
